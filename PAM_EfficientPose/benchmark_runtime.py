...
from model import build_EfficientPose, build_Direct_Concate_EfficientPose, build_Stereo_EfficientPose
...
def main():
    ...
    input_params = {"phi": 0,
                    "dataset": "linemod",
                    "object_id": 35, #this parameter is not used if you use Occlusion
                    "dataset_path": "/home/tianhao/Desktop/dataPAM",
                    # "model_path": "./weights/phi_3/occlusion/phi_3_occlusion_best_ADD(-S).h5"
                    "model_path": "/home/tianhao/Desktop/Stereo.h5"
...
def build_model(phi, model_path, generator):
    ...
    """
    _, model, _ = build_Direct_Concate_EfficientPose(phi,
...
def single_prediction(model, generator, i, number_of_objects = None):
    ...
    image_r = generator.load_image_r(i)
